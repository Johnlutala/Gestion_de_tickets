 ...
 */
final class Version20260303154535 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tb_ticket ADD enabled TINYINT NOT NULL, ADD deleted TINYINT NOT NULL, ADD year INT DEFAULT NULL, ADD month INT DEFAULT NULL, ADD quarter INT DEFAULT NULL, ADD createdby_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tb_ticket DROP enabled, DROP deleted, DROP year, DROP month, DROP quarter, DROP createdby_id');
